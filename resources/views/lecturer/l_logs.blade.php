...
<div id="titlebar">
	<div  id="title">Lecturer<span class="lnr lnr-chevron-right"></span><i> logs</i></div>
		...
		<div class="row w-100">
			<div class="col-lg-12 col-md-10  mx-auto ">
				...
				<?php
					...
					$sql_run = activity_log::where('causer_type',$resultFile)->orderBy('id', 'desc')->get();
					//dd($sql_run);
					//$ss = Activity::all();
					//dd($ss);
					if ($sql_run->count() > 0) {
											...
											if($key == 'attributes'){
												...
												?>
													<span class="text-success">
														<?php echo str_replace('-2-', '-2nd Semester-', str_replace('-1-', '-1st Semester-', str_replace('\\', '',  preg_replace("/[\"\"{\\}]/", " ", json_encode($value))))); ?>
													</span>
												<?php
											}else{
												//get detail of actor
